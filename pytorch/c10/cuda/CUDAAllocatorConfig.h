...
class C10_CUDA_API CUDAAllocatorConfig {
 public:
  ...
  static bool pinned_use_cuda_malloc_managed() {
    return instance().m_pinned_use_cuda_malloc_managed;
  }
 ...
 private:
  ...
  size_t parsePinnedUseCudaHostRegister(
      const c10::CachingAllocator::ConfigTokenizer& tokenizer,
      size_t i);
  size_t parsePinnedUseCudaMallocManaged(
      const c10::CachingAllocator::ConfigTokenizer& tokenizer,
      size_t i);
  ...
  std::atomic<bool> m_pinned_use_cuda_malloc_managed{false};
